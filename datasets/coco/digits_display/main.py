...
if __name__ == '__main__':
    ...
    folder_with_PNG_files = r'/home/gabriel/Documentos/GitHub/datasets/datasets/coco/test_dataset'
    ...
    files = glob.glob(files_with_extension)
    image_counter = 1
    with open(output_file_name, 'w') as output_file:
        for file_name in files:
            ...
            output_file.write('image_' + str(image_counter) +
                              ' ' + os.path.basename(file_name) + os.linesep)
