...
def mnist_classifier(final_image):
    ...
    #From AK Script
    template_file = './templates/template_1.png' #template_1.png is the largest
    ...
    if type(percent_template) is np.ndarray:
        print("ok")
    else:
        raise Exception("Error reading file " + template_file)
